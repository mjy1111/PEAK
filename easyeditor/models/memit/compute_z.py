...
def compute_z(
    ...
    for it in range(hparams.v_num_grad_steps):
        ...
        print(hparams.layer_module_tmp.format(loss_layer), tr[hparams.layer_module_tmp.format(loss_layer)].output[0].shape, full_repr.shape, log_probs.shape)

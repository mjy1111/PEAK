...
class BiEditor:
    ...
    def edit(self,
             ...
             negtive: Optional[Union[str, List[str]]] = None,
             negtive_random: Optional[Union[str, List[str]]] = None,
        ...
        requests = self._prepare_requests(prompts, target_new, ground_truth, relation_id, rephrase_prompts,
                                          locality_inputs, portability_inputs, positive, negtive, negtive_random, **kwargs)
    ...
    def _prepare_requests(self,
        ...
        for prompt, target_new_ , ground_truth_, relation_id_ in zip(prompts, target_new, ground_truth, relation_id)
        ]
        ...
        if negtive_random is not None:

            for i, request in enumerate(requests):
                request.update(
                    {
                        'negtive_random': negtive_random[i],
                    }
                )
